...
public final class ActivityTimerFocusBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityTimerFocusBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityTimerFocusBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityTimerFocusBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_timer_focus, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityTimerFocusBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityTimerFocusBinding((ConstraintLayout) rootView, timerFocus,
